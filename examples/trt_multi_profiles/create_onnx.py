...
def main() -> None:
    ...
    ## dimensions of inputs and outputs have to be set to strings
    ## Using `None` as io dimension cause errors when converting
    ## onnx models to tensorrt
    model_input_name = "X"
    ...
    Y = onnx.helper.make_tensor_value_info(model_output_name,
                                           onnx.TensorProto.FLOAT,
                                           ["batch", model_output_channels, "y_h", "y_w"])
    ...
    graph_def = onnx.helper.make_graph(
        nodes=[conv1_node, bn1_node, relu1_node, conv2_node],
        name="ConvNet",
